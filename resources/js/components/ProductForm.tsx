...
interface ProductFormProps {
  ...
  initialData?: Product;
  categories?: Category[];
  onCreateProduct?: (payload: CreateProductPayload) => Promise<Product | Product[] | undefined>;
  onUpdateProduct?: (id: number, payload: UpdateProductPayload) => Promise<Product | Product[] | undefined>;
  isLoading?: boolean;
